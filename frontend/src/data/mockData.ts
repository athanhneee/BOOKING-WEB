...
export const hostApplications = [
    {
        ...
        documents: {
            type: "cccd",
            frontImage: "https://placehold.co/400x250/e2e8f0/64748b?text=CCCD+Mat+truoc",
            backImage: "https://placehold.co/400x250/e2e8f0/64748b?text=CCCD+Mat+sau",
            fullName: "Nguyễn Minh Thư",
            docNumber: "079201012345",
            birthDate: "2001-05-15",
            address: "123 Đường Lê Lợi, Vũng Tàu",
            expiryDate: "2031-05-15",
            isExpired: false,
            infoMatch: true,
        },
        hostInfo: {
            displayName: "Thư Host",
            bio: "Tôi có villa và homestay tại Vũng Tàu.",
            address: "Vũng Tàu",
            bankName: "MB Bank",
            bankAccount: "0123456789",
            bankHolder: "NGUYEN MINH THU",
        },
    },
    {
        id: "app002",
        ...
        reviewedBy: "Hoàng Văn Nam",
        rejectReason: "Tài liệu mờ, thiếu góc chụp. Vui lòng tải lại ảnh CCCD rõ ràng hơn.",
        documents: {
            type: "cccd",
            frontImage: "https://placehold.co/400x250/fef2f2/ef4444?text=Anh+mo",
            backImage: "https://placehold.co/400x250/fef2f2/ef4444?text=Anh+mo",
            fullName: "Đỗ Hải Yến",
            docNumber: "079205067890",
            birthDate: "2005-08-20",
            address: "456 Đường Thùy Vân, Vũng Tàu",
            expiryDate: "2030-08-20",
            isExpired: false,
            infoMatch: false,
        },
        hostInfo: {
            displayName: "Yến Villa",
            bio: "",
            address: "Vũng Tàu",
            bankName: "Vietcombank",
            bankAccount: "9876543210",
            bankHolder: "DO HAI YEN",
        },
    },
];
