    ...
    const createLocationSuggestions = (): SearchSuggestion[] => {
        const stays = getPopularDestinations().slice(0, 5);
        const accents = [
        ...
        const icons = [
            ...
            <HiOutlineMapPin key="1" size={20} />,
            <HiOutlineSparkles key="2" size={20} />,
            <HiOutlineMapPin key="3" size={20} />,
            <HiOutlineSparkles key="4" size={20} />,
            <HiOutlineMapPin key="5" size={20} />,
        ];
        ...
        return [
            {
                id: "nearby",
                title: "Lân cận",
                description: "Tìm quanh bạn",
                value: "Vũng Tàu",
                icon: icons[0],
                accentClassName: accents[0],
            },
            ...stays.map((stay, index) => ({
                ...
                value: stay.name,
                icon: icons[index + 1],
                accentClassName: accents[(index + 1) % accents.length],
            })),
        ];
    };
