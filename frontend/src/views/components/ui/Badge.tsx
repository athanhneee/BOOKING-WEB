...
const statusMap = {
    ...
    "dang-luu-tru": { label: "Đang lưu trú", className: "border border-teal-200 bg-teal-50 text-teal-700" },
    ...
    "da-tt": { label: "Đã thanh toán", className: "border border-teal-200 bg-teal-50 text-teal-700" },
    trong: { label: "Đang trống", className: "border border-gray-200 bg-gray-50 text-gray-500" },
    active: { label: "Hoạt động", className: "border border-teal-200 bg-teal-50 text-teal-700" },
    ...
    approved: { label: "Đã duyệt", className: "border border-teal-200 bg-teal-50 text-teal-700" },
    ...
    Host: { label: "Host", className: "border border-teal-200 bg-teal-50 text-teal-700" },
