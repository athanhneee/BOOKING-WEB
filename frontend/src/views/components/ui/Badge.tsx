...
const statusMap = {
    "sap-nhan": { label: "Sắp nhận phòng", className: "border border-cyan-200 bg-cyan-50 text-cyan-600" },
    "dang-luu-tru": { label: "Đang lưu trú", className: "border border-cyan-200 bg-cyan-50 text-cyan-600" },
    ...
    "da-tt": { label: "Đã thanh toán", className: "border border-cyan-200 bg-cyan-50 text-cyan-600" },
    trong: { label: "Đang trống", className: "border border-gray-200 bg-gray-50 text-gray-500" },
    active: { label: "Hoạt động", className: "border border-cyan-200 bg-cyan-50 text-cyan-600" },
    ...
    approved: { label: "Đã duyệt", className: "border border-cyan-200 bg-cyan-50 text-cyan-600" },
    ...
    host: { label: "host", className: "border border-cyan-200 bg-cyan-50 text-cyan-600" },
    "host new": { label: "host mới", className: "border border-cyan-200 bg-cyan-50 text-cyan-600" },
