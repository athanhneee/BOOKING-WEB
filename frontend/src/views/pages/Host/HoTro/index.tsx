                ...
                <div className="flex flex-wrap gap-2 rounded-3xl border border-gray-100 bg-white p-3 shadow-sm">
                    {filterOptions.map((option) => (
                        <button
                            ...
                            className={`rounded-3xl px-4 py-2 text-sm font-medium ${status === option.value ? "bg-cyan-50 text-cyan-600" : "text-gray-500 hover:bg-gray-50"}`}
                        >
                            {option.label}
                        </button>
                    ))}
                                                ...
                                                <div className="flex items-center gap-3">
                                                    {listing.imageUrl ? (
                                                        <img
                                                            ...
                                                            alt={listing.title}
                                                            className="h-16 w-24 rounded-3xl object-cover"
                                                        />
                                                    ) : (
                                                        <div className="flex h-16 w-24 items-center justify-center rounded-3xl bg-slate-100 text-xs font-medium text-slate-500">
                                                            Chưa có ảnh
                                                        </div>
                                                    )}
                                                    <div>
                                            ...
                                            <td className="px-4 py-4">
                                                <div className="flex flex-wrap gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="rounded-3xl border border-rose-200 px-4 py-2.5 text-sm text-rose-600 transition-colors hover:bg-rose-50"
                                                    >
