        ...
        return (
            <div className="min-h-screen bg-[#F7F8FA] px-4 py-16">
                <div className="mx-auto max-w-3xl rounded-3xl border border-gray-200 bg-white p-8 text-center shadow-sm">
                    ...
                    <Link
                        to="/noi-luu-tru"
                        className="mt-6 inline-flex rounded-3xl bg-cyan-500 px-5 py-3 text-sm font-semibold text-white"
                    >
        ...
        <div className="min-h-screen bg-[#F7F8FA]">
            ...
            <main className="mx-auto grid max-w-6xl gap-6 px-4 py-8 sm:px-6 lg:grid-cols-2">
                <section className="rounded-3xl border border-gray-100 bg-white p-6 shadow-sm">
                    {listingImage ? (
                        <img src={listingImage} alt={listingName} className="aspect-video w-full rounded-3xl object-cover" />
                    ) : (
                        <div className="flex aspect-video w-full items-center justify-center rounded-3xl bg-gray-100 text-sm font-medium text-gray-500">
                            Đang cập nhật ảnh
                        </div>
                    )}
                    ...
                    <div className="mt-5">
                        ...
                        <div className="mt-6 rounded-3xl border border-gray-100">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid gap-3">
                            <button
                                ...
                                className={`rounded-3xl border p-4 text-left font-semibold disabled:cursor-not-allowed disabled:opacity-60 ${method === "vnpay"
                            ...
                            <button
                                ...
                                className={`rounded-3xl border p-4 text-left font-semibold disabled:cursor-not-allowed disabled:opacity-60 ${method === "momo"
                                    ? "border-cyan-400 bg-cyan-50 text-cyan-600"
                                    : "border-gray-200 text-gray-700"
                                    }`}
                            >
                        ...
                        {error ? (
                            <p className="rounded-3xl bg-rose-50 p-3 text-sm font-semibold text-rose-600">{error}</p>
                        ) : null}
                        ...
                        <button
                            ...
                            className="w-full rounded-3xl bg-cyan-500 px-4 py-3 font-medium text-white transition-colors hover:bg-cyan-500 disabled:opacity-60"
                        >
                            {isSubmitting ? (
                                <span className="inline-flex items-center gap-2">
