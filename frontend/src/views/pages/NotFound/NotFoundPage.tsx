...
const NotFoundPage = () => {
    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-cyan-50 via-white to-cyan-50">
                    ...
                    <div className="mt-8 grid gap-4 text-left sm:grid-cols-2">
                        ...
                        <div className="rounded-2xl border border-cyan-200/80 bg-white/75 p-5 shadow-[0_18px_40px_rgba(15,118,110,0.12)] backdrop-blur">
                            ...
                            <Link
                                ...
                                className="mt-4 inline-flex text-sm font-semibold text-cyan-500 transition-colors hover:text-cyan-500"
                            >
