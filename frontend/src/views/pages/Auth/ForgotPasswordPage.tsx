        ...
        >
            {isSuccessStep ? (
                <div className="space-y-6 font-sans">
                    ...
                    <Link
                        to={APP_ROUTES.login}
                        className="inline-flex min-h-15 w-full items-center justify-center gap-3 rounded-3xl bg-[#5d53f7] px-6 py-4 font-sans text-lg font-semibold text-white shadow-[0_18px_40px_-18px_rgba(93,83,247,0.8)] transition-transform duration-200 hover:-translate-y-0.5 hover:bg-cyan-500"
                    >
                        Quay lại đăng nhập
                ...
                <>
                        ...
                        <div className="grid grid-cols-6 gap-2 sm:gap-3" onPaste={handleOtpPaste}>
                            {otpDigits.map((digit, index) => (
                                <input
                                    ...
                                    className="aspect-[0.82] w-full rounded-3xl border border-slate-200 bg-white text-center font-sans text-4xl font-semibold text-slate-500 outline-none transition-colors placeholder:text-slate-300 focus:border-cyan-500 sm:text-5xl"
                    ...
                    <div className="mt-7 text-center font-sans text-sm text-slate-600 sm:text-base">
                        ...
                        {resendCountdown > 0 ? (
                            <span className="font-medium text-cyan-500">Gửi lại mã OTP sau {resendCountdown}s</span>
                        ) : (
                            <button
                                type="button"
                                onClick={handleResendOtp}
                                className="font-semibold text-cyan-500 transition-colors hover:text-[#4b40ef]"
                            >
                                Gửi lại mã OTP
                            </button>
                        )}
                ...
                <>
                    ...
                    <div className="mt-7 text-center">
                        <Link
                            to={APP_ROUTES.login}
                            className="inline-flex items-center gap-2 font-sans text-base font-semibold text-cyan-500 transition-colors hover:text-[#4b40ef]"
                        >
                            <LuArrowLeft />
                            Quay lại đăng nhập
                        </Link>
