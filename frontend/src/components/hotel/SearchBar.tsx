...
import { FaCity, FaLocationArrow, FaMapMarkerAlt, FaSearch, FaTimes, FaUmbrellaBeach } from "react-icons/fa";
import useScrollVisibility from "../../hooks/useScrollVisibility";
import Checkin from "./Checkin";
import Checkout from "./Checkout";
import Guest, { type GuestSelection } from "./Guest";
    ...
    return (
        <>
                            ...
                            <div className={`relative min-w-0 transition-[flex] duration-[760ms] ease-[cubic-bezier(0.22,0.61,0.36,1)] ${desktopFieldClass("location")}`}>
                                ...
                                >
                                    ...
                                    <div className="min-w-0 text-left">
                                        <p className="text-[11px] font-semibold uppercase tracking-wide text-gray-700">Địa điểm</p>
            ...
            {isMobileSheetMounted ? (
                ...
                <div
                    className={`absolute inset-x-0 bottom-0 top-0 overflow-y-auto rounded-t-[36px] bg-[#efefef] px-4 pb-32 pt-4 shadow-2xl transform-gpu transition-[transform,opacity] duration-[1300ms] ease-[cubic-bezier(0.16,1,0.3,1)] will-change-transform ${isMobileSheetOpen ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
                >
                    <button
                        type="button"
                    ...
                    <section className="rounded-[34px] border border-gray-200 bg-white p-5 shadow-sm">
                        ...
                        <div className="mt-6 space-y-6">
                            <div>
                                <p className="mb-3 text-2xl font-semibold text-gray-900">Những tìm kiếm gần đây</p>
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <p className="text-2xl font-semibold text-gray-900">Đà Lạt</p>
                                        <p className="text-xl text-gray-600">10 - 14 thg 3 · 2 khách</p>
                                    </div>
                                </div>
                            </div>

                            <div>
                                <p className="mb-3 text-2xl font-semibold text-gray-900">Điểm đến được đề xuất</p>
                                <div className="space-y-3">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <p className="text-xl font-semibold text-gray-900">Lân cận</p>
                                            <p className="text-lg text-gray-600">Tìm xung quanh bạn</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <p className="text-xl font-semibold text-gray-900">Vũng Tàu</p>
                                            <p className="text-lg text-gray-600">Khách quan tâm đến Đà Lạt cũng tìm khu vực này</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className={`overflow-hidden transition-[max-height,opacity,margin] duration-[1100ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${mobileSection === "time" ? "mt-3 max-h-[560px] opacity-100" : "max-h-0 opacity-0"}`}>
                            ...
                            <div className="grid grid-cols-1 gap-3">
                                <label className="text-sm font-semibold text-gray-600">
                                    ...
                                    <input
                                        ...
                                        className="mt-1 w-full rounded-xl border border-gray-200 px-3 py-3 text-base text-gray-800 outline-none focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20"
                                    />
                                </label>
                            ...
                            <div className="mt-3 flex flex-wrap gap-2">
                                {[0, 1, 2, 3, 7].map((offset) => (
                                    <button
                                        key={offset}
                                        type="button"
                                        onClick={() => handleNightOffsetChange(offset)}
                                        className={`rounded-full border px-3 py-1.5 text-xs font-semibold transition ${nightOffset === offset ? "border-gray-900 bg-gray-900 text-white" : "border-gray-300 bg-white text-gray-700"}`}
                                    >
                                        {offset === 0 ? "Ngày chính xác" : `± ${offset} ngày`}
                                    </button>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className={`overflow-hidden transition-[max-height,opacity,margin] duration-[1100ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${mobileSection === "guest" ? "mt-3 max-h-[460px] opacity-100" : "max-h-0 opacity-0"}`}>
                        <div className="rounded-3xl border border-gray-200 bg-white p-4 shadow-sm">
